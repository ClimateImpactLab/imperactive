...
from imperact.controllers.error import ErrorController
...
class RootController(BaseController):
    """
    The root controller for the Imperact application.
    ...
    def _before(self, *args, **kw):
        tmpl_context.project_name = "imperact"

    @expose('imperact.templates.index')
    def index(self):
        """Handle the front-page."""
        return dict(page='index')
    @expose('imperact.templates.about')
    def about(self):
        """Handle the 'about' page."""
        return dict(page='about')

    @expose('imperact.templates.environ')
    def environ(self):
        """This method showcases TG's access to the wsgi environment."""
        return dict(page='environ', environment=request.environ)

    @expose('imperact.templates.data')
    @expose('json')
    def data(self, **kw):
        """
    ...
    @expose('imperact.templates.login')
